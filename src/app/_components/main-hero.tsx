...
export function MainHero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full w-full bg-black bg-opacity-50 p-14 pt-36 lg:pt-56">
        <h1 className="mb-4 text-5xl font-bold text-white md:text-6xl lg:text-8xl">
          Delicious & <br /> Nutritious Catering <br /> for a Healthier You!
        </h1>
        <p className="mb-6 max-w-[70vh] text-xl text-white lg:text-2xl">
